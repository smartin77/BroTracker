...
This document lists tracker projects that BroTracker uses as references for workflow, architecture, playback, user interface and other design ideas.
...
This list may grow as additional tracker projects become relevant to BroTracker development.
